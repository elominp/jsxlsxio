...
napi_value create_xlsxioread_sheetlist_close_wrapper(napi_env env) {
  ...
  ASSERT(napi_create_function(env, "xlsxioread_sheetlist_close", NAPI_AUTO_LENGTH,
...
napi_status set_xlsxioread_sheetlist_close_wrapper(napi_env env, napi_value result) {
  return napi_set_named_property(env, result, "xlsxioread_sheetlist_close",
